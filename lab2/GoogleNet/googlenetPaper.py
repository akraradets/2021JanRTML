...
from myModulePaper import GoogLeNet
...
best_model, val_acc_history, loss_acc_history = train_model(model, dataloaders, criterion, optimizer, 50, 'google_scratch_augment_paper_lr_0.001_bestsofar', is_inception=True)

import pickle
with open("google_scratch_augment_paper_val_acc_history.txt", "wb") as f:
    pickle.dump(val_acc_history, f)

with open("google_scratch_augment_paper_loss_acc_history.txt", "wb") as f:
