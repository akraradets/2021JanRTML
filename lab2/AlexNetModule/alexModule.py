...
best_model, val_acc_history, loss_acc_history = train_model(alexnet, dataloaders, criterion, optimizer, 50, 'alex_module_augment_LRN_lr_0.001_bestsofar')

import pickle
with open("alexModule_augment_val_acc_history.txt", "wb") as f:
    pickle.dump(val_acc_history, f)

with open("alexModule_augment_loss_acc_history.txt", "wb") as f:
